    ...
    <main>
      ...
      <div class="info-box">
        ...
        <div class="info-container">
          <div class="one-info">
            ...
            <p class="detail"> Paiement Acoompte</p>
          </div>
      ...
      <div class="info-box">
        ...
        <div class="info-container">
          ...
          <div class="one-info">
            <p class="info-title">Prix à payer  :</p>
            <p class="detail"> ${price - accompte} </p>
          </div>
           <div class="one-info">
      ...
      >
        ...
        <p class="note-important">
          ...
          votre arrivée à l'hôtel et payer le reste du montant à l'hotel
        </p>
      </div>
    </main>
    <footer>
...
module.exports = generate_bon_html3;
